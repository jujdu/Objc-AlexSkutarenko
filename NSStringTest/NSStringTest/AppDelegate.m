...
//    NSLog(@"%@", string);
//
//    NSRange range = [string rangeOfString:@"world" options:NSCaseInsensitiveSearch | NSBackwardsSearch];//любой регистр
//
//
...
//    NSRange range = [text rangeOfString:@"Пишущим средством в этом случае, как правило," options:NSCaseInsensitiveSearch];
//
//    if (range.location != NSNotFound) {
...
//    text = [text stringByReplacingOccurrencesOfString:@"NSString" withString:@"WOW"];
